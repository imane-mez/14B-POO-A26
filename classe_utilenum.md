...
string description = type.GetDescription(); // Retourne "Rapport technique"

type = TypeDocument.Brouillon;
description = type.GetDescription(); // Retourne "Brouillon"
```
